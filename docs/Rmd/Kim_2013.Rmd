...
---
title: "Pasta Analysis Tutorial: Kim, Aging Cell, 2013"
...
Before running this tutorial, please ensure that the following packages are installed: **pasta**, **jsutil**, **magrittr**, **data.table**, **ggplot2**, **gtools**, **GEOquery**, and **biomaRt**.

You can install any missing packages using `install.packages()`, `BiocManager::install()` for bioconductor packages, or `devtools::install_github()` for GitHub packages.
...
# Extract phenotype data; here, we assume population doubling info is in column 31
...
# Melt pdata1 into long format; using the column names of pdata1 as identifier variables
