...
- [Data acquisition, age-prediction, and
  ...
  - [Gene ID conversion using
    biomaRt](#gene-id-conversion-using-biomart)
  - [Processing Expression data](#processing-expression-data)
  - [Adding metadata and predicted
    ages](#adding-metadata-and-predicted-ages)
...
Before running this tutorial, please ensure that the following packages
are installed: **pasta**, **magrittr**, **data.table**, **ggplot2**,
**gtools**, **GEOquery**, and **biomaRt**.

You can install any missing packages using `install.packages()`,
`BiocManager::install()` for bioconductor packages, or
`devtools::install_github()` for GitHub packages.
...
We now define a data table for beta-galactosidase measurements (a proxy
for senescence) and add age predictions.
...
![](/raid/jersal/workspace/pasta/doc/tutorials/Kim_2013_files/figure-gfm/plot-visualization-1.png)<!-- -->
