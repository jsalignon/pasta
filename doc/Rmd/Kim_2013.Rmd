...
Before running this tutorial, please ensure that the following packages are installed: **pasta**, **magrittr**, **data.table**, **ggplot2**, **gtools**, **GEOquery**, and **biomaRt**.
...
We now define a data table for beta-galactosidase measurements (a proxy for senescence) and add age predictions.
...
# Use dt_beta_gal as phenotype data and add age predictions
